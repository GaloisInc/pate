    ...
    discoverCheckingHints repr e = do
      ...
      if | PH.hints e == mempty -> do
         ...
         | otherwise -> do
             ...
             let unhintedDiscoveredAddresses = S.fromList (PMC.parsedFunctionEntries oPfmUnhinted)
             let hintedDiscoveredAddresses = S.fromList (PMC.parsedFunctionEntries oPfmHinted)
